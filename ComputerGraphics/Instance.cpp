...
glm::mat4 Instance::MakeTransform(glm::vec3 position, glm::vec3 eularAngles, glm::vec3 scale)
{
	...
	transform = glm::rotate(transform, glm::radians(eularAngles.z), glm::vec3(0, 0, 1));
	transform = glm::rotate(transform, glm::radians(eularAngles.y), glm::vec3(0, 1, 0));
	transform = glm::rotate(transform, glm::radians(eularAngles.x), glm::vec3(1, 0, 0));
